import { REPHRASE_CREATE_REPHRASE_PROJECT, REPHRASE_DELETE_REPHRASE_PROJECT, REPHRASE_GET_REPHRASE_OPTIONS, REPHRASE_GET_REPHRASE_PROJECTS, REPHRASE_IS_LOADING, REPHRASE_UPDATE_REPHRASE_PROJECT, TRephraseProject, TRephraseResponse, rephraseDispatchTypes } from "../../actions/rephrase/types"
...
const rephraseReducer = (state: IDefaultState = defaultState, action: rephraseDispatchTypes) => {
    switch (action.type) {
        ...
        case REPHRASE_DELETE_REPHRASE_PROJECT:
            return state
